...
export declare function formattedOutput(mml: Element, expr: Element, tree: SemanticTree, opt_wiki?: boolean): void;
export declare function formattedOutput_(element: Element | SemanticTree, name: string, wiki: boolean): void;
