...
function getLocale() {
    const locale = engine_1.default.getInstance().locale;
    if (variables_1.Variables.LOCALES.indexOf(locale) === -1) {
        console.error('Locale ' + locale + ' does not exist! Using en instead.');
        engine_1.default.getInstance().locale = 'en';
    }
    return (exports.locales[engine_1.default.getInstance().locale] || exports.locales['en'])();
}
