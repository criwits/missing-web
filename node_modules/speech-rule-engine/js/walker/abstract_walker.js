...
class AbstractWalker {
    ...
    getFocus(update = false) {
        if (!this.focus_) {
            this.focus_ = focus_1.Focus.factory(this.rootId, [this.rootId], this.getRebuilt(), this.node);
        }
        if (update) {
            this.updateFocus();
        }
    ...
    home() {
        ...
        const focus = focus_1.Focus.factory(this.rootId, [this.rootId], this.getRebuilt(), this.node);
        return focus;
    }
    getBySemanticId(id) {
    ...
    rebuildStree() {
        const rebuilt = new rebuild_stree_1.RebuildStree(this.getXml());
        this.rootId = rebuilt.stree.root.id.toString();
        this.generator.setRebuilt(rebuilt);
        this.focus_ = focus_1.Focus.factory(this.rootId, [this.rootId], rebuilt, this.node);
        this.levels = this.initLevels();
