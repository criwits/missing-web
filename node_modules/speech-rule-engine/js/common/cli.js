...
class Cli {
    constructor() {
        ...
        this.dp = new system_external_1.default.xmldom.DOMParser({
            errorHandler: function (_key, _msg) {
    ...
    loadLocales() {
        return __awaiter(this, void 0, void 0, function* () {
            for (const loc of variables_1.Variables.LOCALES) {
    ...
    execute(input) {
        const options = system_external_1.default.commander.opts();
    ...
    readline() {
        ...
        const inter = system_external_1.default.extRequire('readline').createInterface({
            ...
            output: options.output
                ? system_external_1.default.fs.createWriteStream(options.output)
                : this.process.stdout
        });
        let input = '';
        inter.on('line', ((expr) => {
    ...
    commandLine() {
        ...
        if (options.verbose) {
            debugger_1.Debugger.getInstance().init(options.log);
        }
        if (options.input) {
        ...
        debugger_1.Debugger.getInstance().exit(function () {
            System.exit(0);
        });
    }
