...
export declare function trimInput_(input: string): string;
export declare const XML_ENTITIES: {
    [key: string]: boolean;
};
...
export declare function matchingStartEnd_(start: string, end: string): [boolean, string];
export declare function dataAttribute(attr: string): string;
export declare function getDataAttribute(node: Element, attr: string): string;
