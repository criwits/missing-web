...
exports.tagName = exports.querySelectorAll = exports.querySelectorAllByAttrValue = exports.querySelectorAllByAttr = exports.getDataAttribute = exports.dataAttribute = exports.matchingStartEnd_ = exports.formatXml = exports.createTextNode = exports.createElementNS = exports.createElement = exports.replaceNode = exports.NodeType = exports.parseInput = exports.XML_ENTITIES = exports.trimInput_ = exports.toArray = void 0;
...
function matchingStartEnd_(start, end) {
    if (!end) {
        return [false, ''];
    }
...
exports.matchingStartEnd_ = matchingStartEnd_;
function dataAttribute(attr) {
    if (attr.match(/^data-/)) {
        attr = attr.substr(5);
    }
...
function getDataAttribute(node, attr) {
