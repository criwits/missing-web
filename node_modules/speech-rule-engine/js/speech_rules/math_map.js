...
exports.loadAjax = exports.loadFileSync = exports.loadFile = exports.parseMaps = exports.retrieveFiles = exports.loadLocale = exports.init = exports.store = void 0;
...
function init() {
    ...
    return engine_1.EnginePromise.promises['base'];
}
exports.init = init;
...
function retrieveFiles(locale) {
    ...
    const promise = new Promise((res) => {
        ...
        inner.then((str) => {
            ...
            engine_1.default.getInstance().locale = 'en';
            res(locale);
        });
    });
