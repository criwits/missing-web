...
然而，**由于搜索引擎内存在广告，搜索结果中靠前的结果并不一定是官网**。例如，我们想要下载「WPS」，直接在百度中搜索「WPS 下载」，我们会得到这样的搜索结果：
...
- 第二条是「腾讯电脑管家」提供的广告，进去之后八成我们会下载到「腾讯电脑管家」而不是「WPS」。
...
假设经过与网站的「斗智斗勇」，你成功地下载到了某款软件的安装包。取决于软件，你下载到的可能是下面三种文件中的某一种：
