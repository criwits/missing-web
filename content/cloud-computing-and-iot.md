...
「是的。**这种架构就是『本地部署』：服务器位于每个组织的本地，由组织自己管理**。但是很显然，这种模式让那些小微企业难以负担，将无数想进军互联网行业的人挡在了门外。」

「诶，『本地部署』这个词我好像也在好多 [讨论 AI 的文章]({{<relref "bring-intelligence-to-machines.md#本地部署成为新宠儿">}}) 里都看到过，它们是同一个『本地部署』吗？」
...
但是免费平台终究有其限制：访问速度差强人意、存储空间相当有限，他们开始寻求更好的方案。他精挑细选，在一家国内的云计算平台开通了一种「云对象存储」服务。他们将自己的网页上传到其中，即可在全球范围内高速访问，只需按照使用的存储空间大小和访问流量支付少许费用。
