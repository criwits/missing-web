...
虽然三十分钟对于地铁旅途而言算有点久了，但对起床下楼而言却有些仓促。南方沿海九月的午后，大气对流裹挟的雨水总是不期而至。Windy 望着雨幕，在地铁站出口坐了一会，终于看到了 Hans 匆忙而至的身影与他手中的两把伞。
...
她打开与智能手表配对的 app，一时愕然——一模一样的健康警告不止一条，而是最近几天都有。到了公司，她不再耽搁，立刻请假，前往医院进一步检查。
...
「对，相比之前的云服务器『卖平台』，这些产品更像是在『卖应用』。用户买到的不是一台完整服务器，也无需学习服务器的配置和使用，而是由服务器提供的某一项具体功能。除了这些云盘和云文档以外，我们当初用的『从文档生成网站』的服务也是一个例子，我们不需要考虑具体如何搭建网站，只要写两个配置，就能直接用了。」

（一张图）

「除了这种『卖应用』的模式，我好像还见过些别的，比如『云电脑』『云游戏』什么的。这应该也是虚拟机的一种呈现形式，既然云计算服务商能虚拟出一堆好用的服务器，那虚拟出一台普通电脑，或者游戏电脑，也不是什么难事。这样，暂时买不起高性能游戏电脑或手机的人们，可以借助云服务的虚拟机，来玩想玩的游戏，或在云电脑上安装自己需要的软件，获得更好的体验。」

「事实上，这也是『算力集中化』的进一步体现。在云游戏和云电脑普及开来后，高性能的算力集中到了云计算服务商那里。之前，游戏玩家都需要自己购买高配置的 CPU、显卡等硬件，在云的时代，用户访问高性能硬件的付费，从一次买断变成了低价按量购买。」

「不过说到底，这么些服务还是基于网络的，先不说没网就用不了，云盘还需要高速传输才好用，而云电脑或者云游戏，超低延迟是硬指标。只待更先进的高速 WiFi 标准，以及 5G 的全面普及，高速高质低价格的网络成为可能，才能更有力地推动云服务的发展。」

「我们平常用的网盘还算好，慢就慢点，至少你的资料是一分不少。不像某些云盘服务，用着用着，有时候你的文件就不见了，本来生态又封闭，想找回文件更是难上加难、雪上加霜。」Hans 对不知哪家云服务厂商如是评价。

「不会吧，这样的厂商还有人用？」

「谁知道呢——总之，这么一会下来，我们大学城就差不多逛完了，还是挺小的吧。」

「确实，但是它高级啊。剩下还有时间，之后去哪玩呢？」Windy 人生地不熟。

「之后我们去附近的海湾公园看看吧。」于是两人踏上旅途。

Windy 想起什么，戳了几下自己的智能手表：「在云服务平民化的推动下，其实如今物联网也不是大厂才能用上的玩意了，比如说我家里就有一些智能家具，通过『智能家居』云服务，和家里人的手机绑定，就能远程控制。而我的手机又和我的手表配对，这下在手表上也能控制了。」
...
「反正，这些智能家居，在嵌入式计算机的加持下，能够联网、远控，据说更高级的还能分析数据，让生活变得更加方便。像『她』的手表那样的健康监测系统，也早就集成在小巧的手表中，及时反映我们的身体状况。从工业到民用，物联网的边界还在不断拓展。」

从大学城到海湾公园不算遥远，也就几站路。从地铁站出来，柔和海风、绿树青草触手可及，还有人、人，以及更多的人，在公园游走。
...
清晨，随着一阵轻音乐，遮光窗帘自动缓缓滑开，让晨光洒入房间。她随着乐声醒来，拿起手机，关闭闹铃，「您昨晚睡眠质量良好」。起床，洗漱，走进厨房，拿出自动烹饪机器刚刚准备好的早餐，「根据您最近的健康状况，早餐特别添加富含维生素 D 的金枪鱼肉」。手机上又弹出通知：「您的牛奶已送达，请及时拿取。」她转头，看见阳台上的新鲜牛奶，伴随着逐渐远去的无人机机翼声，她取回牛奶，开始享受早餐。
...
Hans 笑言：「虽然是这样，但幻想将来不也是一件美好的事情吗？在如今科技的浪潮中，[人工智能]({{<relref "bring-intelligence-to-machines.md">}})、[密码学与网络安全]({{<relref "introduction-to-cryptology.md">}})、[程序语言与计算技术]({{<relref "program-and-arch.md">}})，以及 [云计算和物联网]({{<relref "cloud-computing-and-iot.md">}}) 技术，正撼动着各自原本封闭的孤岛，交融成为一块整体的大陆。它们的互相成就，不仅拓展了技术的边界，更在人类生活的方方面面开启了新篇章。」
...
「但是要打破壁垒，岂不是意味着技术开放？这样的开放，肯定会包含一些安全隐患吧？」

「没错，即便是现在，数据隐私和网络攻击都不时成为社会热点，但密码学与网络安全技术正在为隐私保驾护航。在传统的加密、哈希、签名和证书技术的基础上，人们又研究出了用于隐私计算的安全多方协议，更有『零知识证明』和『联邦学习』等等新兴技术。在云与物联的世界中，这些新兴的保护手段不仅在云端构筑了坚不可摧的防线，更延伸到了每一台 IoT 设备、每一个边缘节点，技术生态在透明与隐私之间终究找到了平衡。」
