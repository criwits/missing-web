...
「这就是『物联网』的力量了。『云』是中心，那么『物』就是边缘。**物联网的目标，就是让万物都成为『边缘』，接入网络**。」Hans 准备终结盘里的牛排。

![中心和边缘](cloud-computing-and-iot/Centre_and_edge.png#center)

「所以，借助物联网，工厂里那些机器也变成了网络的一部分。这样一来，机器工作过程中的实时状态都能通过网络传到云服务器进行分析，再向管理者的电脑发送结果。那么，整个车间的生产情况、存在的隐患、各种机床的实时工况，都能为管理者所知。」
...
「的确如此。曾经，云计算服务商主要是提供各种云服务器，客户大多都是有一定规模的企业与组织，这种模式叫「**基础设施即服务**」，简称 IaaS。现在，云计算则演化出「**平台即服务**」和「**软件即服务**」的新形态，分别简称 PaaS 和 SaaS——**用户不用再买完整的服务器，也无需学习服务器的配置和使用，而是选购云计算厂商提供的某一项具体功能或服务**。

「你这么说，那我们常用的各种『网盘』，还有当初我们用的『在线文档』，也是这种云计算模式？」

「对。相比 IaaS 的『卖算力』，PaaS 和 SaaS 就是在『卖应用』。除了云盘和云文档以外，我们当初用的『从文档生成网站』的服务也是一个例子，我们不需要考虑具体如何搭建网站，只要配置一下，就能直接用了。」

|      |  IaaS | PaaS 和 SaaS |
|:-:   | -------- | ------|
| 产品种类 | 单一<br>基础计算资源（如云服务器）   | 多样<br>各种应用和平台   |
| 定价 | 较高<br>按租用时长或用量计费 | 较低<br>通常按使用量或用户数计费 |
| 易用性 | 低<br>需要使用者掌握服务器运维知识，需要手动搭建各种服务 | 高<br>容易上手，无需或只需少量专业知识 |
| 受众 | 企业、组织、专业人士 | 企业、组织、专业人士、大众 |

「我想起一种特殊的云服务：『云电脑』『云游戏』什么的。这么来看，它们其实是这两大类模式的混合：硬件上，它们是 IaaS 的一种呈现形式，既然云计算服务商能虚拟出一堆好用的服务器，那虚拟出一台普通电脑，或者游戏电脑，也不是什么难事；不过从易用性看，用户很轻松地就可以进行购买、使用它们，甚至都不用自己安装软件，又颇有 SaaS 的感觉。」
...
Windy 想起什么，戳了几下自己的智能手表：「说起物联网，我觉得如今物联网也不是工厂里才能用上的玩意了。比如说我家里就有一些智能家具，能直接连到我家的 WiFi，我在手表上也能远程控制它们。」

「好家伙，给我看看。」

「你看，点这里，门就可以反锁或者解除反锁，还能查看最近的开门记录；点这个灯，就可以开灯或者关灯，还能调亮度。还有别的什么冰箱啊路由器什么的，都可以统一控制……」

![Windy 的智能手表](cloud-computing-and-iot/Smart_watch.png#center)
...
![海湾公园](cloud-computing-and-iot/The_seaside_park.jpg#center)
...
![夕阳](cloud-computing-and-iot/The_dusk.jpg#center)
