...
上文提到了一个叫做 `文档` 的文件夹，它是系统预置的一个用户文件夹。除了「文档」之外，Windows 还提供了「图片」「下载」「视频」等多个用户文件夹。对于 Windows 11，你可以在【此电脑】窗口的左侧看到这些文件夹。

![Windows 11 用户文件夹](file-and-file-management/Win11_user_folders.png#center)

Windows 10 上则可以通过双击桌面上的【此电脑】，展开【文件夹】折叠项看到这些文件夹：
