...
> 尽管 IE 已经被这个时代抛弃，但是每个时代都有自己的「IE」——例如，今天苹果的 Safari 浏览器，就和过去的 IE 有着一样的毛病：与系统捆绑更新，对漏洞的修复并不及时；对新标准的支持并不完整；性能相对低下，功能严重不足……而苹果更令人不齿的是，它在移动设备（即 iOS 和 iPad OS）上强制所有第三方浏览器都必须使用 Safari 内核，完全剥夺了用户的选择权。可惜，由于苹果孤行己见、财大气粗、目中无人，即使与时代之势背道而行，Safari 也在短期内不会有像 IE 那样的命运。
