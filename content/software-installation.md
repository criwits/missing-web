...
- 看网址。网址的格式类似于 <code>https://www.<u>example.com</u>/some/page/...</u></code>，我们需要着重关注这里画了下划线的部分——主域名。一般来说，软件的官网的主域名往往与软件厂商的名称相关联。例如：
...
与那些用来盈利的商业软件不同，「自由与开源软件」（free and open-source software，简称 FOSS）不仅是免费的，而且还允许用户在一定条款之下自由地共享、分发，甚至是修改它们的源代码，来基于它们创造出新的软件。这使得自由和开源软件能够集思广益，实现「众人拾柴火焰高」：软件的发展离不开社区的贡献，而社区又随着软件的发展而更加壮大。近些年来，自由和开源软件作为一种新浪潮，在越来越多的领域开始出现，并开始动摇过去一些不可或缺的商业软件的地位。
