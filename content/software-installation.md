...
《你缺失的那门计算机课》相信自由与开源软件的力量，始终支持它们的发展。在本书的创作过程中，我们就使用了大量的自由与开源软件来进行内容创作，如使用 [Inkscape](https://inkscape.org/) 绘制所有的示意图，以及使用 [GIMP](https://www.gimp.org/) 进行原始照片的处理。我们鼓励大家在实际使用电脑的过程中，多多尝试、使用一些优质自由与开源软件。在本书的后续章节中，我们会推荐一批各个领域的优质软件，其中就有许多自由与开源软件的身影。
