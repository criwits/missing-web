...
- 看网址。对于一个网址 <code>https://www.<u>example.com</u>/some/page/...</u></code>，我们关注它的主域名部分，即 `example.com`。一般来说，软件的官网的主域名往往与软件厂商的名称相关联。例如：
...
{{<hint warning>}}
注意：你可以按上文介绍的操作将软件安装到 C 盘以外的分区；但若想把软件安装到 C 盘，请保持默认安装路径，不要更改。受 C 盘权限机制的影响，将软件随意安装到 C 盘内的其他位置可能会出现问题。
{{</hint>}}
