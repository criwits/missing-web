...
当然，英特尔肯定不会在明面上使用「AMD64」这个名字。他们把它改名成了「Intel 64」。世人一想，你们这各自拉扯，我们到底应该用哪个名称呢？于是，人们索性用「x86-64」来表示这种「64 位的 x86 指令集」，以和原本纯 32 位的 x86 作区分。后来，人们也会把「x86-64」简称为「x64」，用来表示这种指令集。后来的故事，就是在本书的第一章 [认识你的电脑]({{<ref "computer-and-its-components.md">}}) 中所介绍的了那样了——英特尔和 AMD 成为了 x86-64 指令集的两大霸主，开始统治着全世界的电脑 CPU 市场，直到今天。
