...
如果某一章节的标题后带有星号「*」，表明这一章节内容比较难以理解，可以选择性阅读。
...
你可能会听说过「控制面板」这个词，它是 Windows 10 之前的 Windows 系统中用来调整系统设置的应用。在 Windows 10 和 Windows 11 中，「控制面板」仍然存在，但它的功能已经被「设置」app 所取代。如果你在文中看到「控制面板」这个词，我们会特别说明。
