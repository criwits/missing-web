...
我们已经知道，Windows 自己的磁盘管理工具只能在分区末尾操作，像上图这样的分区结构，想扩容 C 盘它无能为力。但是，非系统盘的分区却似乎可以直接用【扩展卷】操作。于是，有些好奇心旺盛的用户，在磁盘管理工具里点击【扩展卷】，然后一顿操作，把硬盘变成了「动态磁盘」。就像下图中想把剩余空间塞给 E 盘的操作（**错误操作，请勿模仿！！！**）：
