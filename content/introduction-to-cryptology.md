...
在上世纪末 DES 被证实不再安全之后，美国 NIST 除了亡羊补牢式地提出 3DES 外，亦开始物色新的更安全的加密算法。由比利时密码学家 Joan Daemen 和 Vincent Rijmen 所设计的一款算法最终脱颖而出，于 2001 年被命名为「高级加密标准」（AES）并公布。自此，属于 DES 和 3DES 的「城池」迅速被 AES 攻破。直到今天，AES 仍然是事实上最被广泛使用的对称加密算法，并且依然有着无与伦比的安全性。
