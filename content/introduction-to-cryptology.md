...
![让「信用大户」来确保公钥的真实性](introduction-to-cryptology/Signing_with_CA.png#center)
...
5. 假设你需要收集本部门申请特殊补贴员工的材料。现在，你想让大家确认自己的文件是否已被收到，但为了保护隐私，不能直接向所有人展示收到的文件，你可以怎么做？（提示：文件哈希值。）
