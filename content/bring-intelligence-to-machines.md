...
我们用一个生动形象的比喻来结束这一节的内容。诸如智谱、深度求索这样的公司如同一个个果农，它们所研发的各种 AI 模型就是各种口味不同的水果。这些果农各自开设了自己的「直营水果店」（网站和 app），我们可以方便地前往这些直营店进行选购。如果一段时间内某种水果特别畅销，水果店门前就要排起长龙了——同时，晚到的顾客很可能只能两手空空地离开。

有些果农志向远大，决心造福人类，于是将自己培育果树的秘方公之于众（开源模型）。这样，我们也可以选择按照它们的配方，在自己的田地上种出同样的水果。不过，与那些果农相比，我们自己手中往往没有那么多的余田，因此种出的水果经常产量不高，有时质量也略差。
